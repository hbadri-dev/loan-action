        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-center space-x-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="mr-2 text-sm font-medium text-gray-500 dark:text-gray-400">کارمزد</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('seller.sale.verify-contract.post', $auction) }}">
                        @csrf
                    ...
                    <div class="text-center mb-6">
                        <form method="POST" action="{{ route('seller.sale.contract.otp', $auction) }}" class="inline">
                            @csrf
                            <button type="submit"
