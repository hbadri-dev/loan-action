    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="mr-1 text-gray-500 md:mr-2 dark:text-gray-400">افزودن لینک</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                <span class="text-gray-600 dark:text-gray-400">مزایده:</span>
                                <span class="font-medium text-gray-900 dark:text-gray-100">
                                    {{ $sale->auction->title }}
                                </span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <span class="font-medium text-gray-900 dark:text-gray-100">
                                    {{ number_format($sale->auction->principal_amount) }} تومان
                                </span>
                            </div>
                        </div>
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                <span class="text-gray-600 dark:text-gray-400">کارمزد (1%):</span>
                                <span class="font-medium text-orange-600 dark:text-orange-400">
                                    {{ number_format($sale->selectedBid->amount * 0.01) }} تومان
                                </span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-green-200 dark:border-green-700">
                                <span class="text-gray-900 dark:text-gray-100 font-semibold">مبلغ نهایی پرداخت:</span>
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                <span class="text-gray-600 dark:text-gray-400">تاریخ پذیرش:</span>
                                <span class="font-medium text-gray-900 dark:text-gray-100">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">افزودن لینک پرداخت</h3>

                    <!-- Instructions -->
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
                        <h4 class="font-semibold text-blue-900 dark:text-blue-100 mb-2">دستورالعمل:</h4>
                        <ul class="text-sm text-blue-700 dark:text-blue-300 space-y-1 list-disc list-inside">
                            <li>لینک پرداخت را از درگاه پرداخت خود ایجاد کنید</li>
                            <li><strong>مبلغ باید دقیقاً {{ number_format($sale->selectedBid->amount + ($sale->selectedBid->amount * 0.01)) }} تومان باشد</strong> (شامل 1% کارمزد)</li>
                            <li>پس از ثبت، لینک برای خریدار نمایش داده می‌شود</li>
                            <li>خریدار پس از پرداخت به آدرس callback برمی‌گردد</li>
                        </ul>
                    </div>

                    <form action="{{ route('admin.payment-links.store', $sale) }}" method="POST" class="space-y-6">
                        @csrf

                        <div>
                            <label for="payment_link" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                لینک پرداخت <span class="text-red-500">*</span>
                            </label>
                            <input type="url"
                                   id="payment_link"
                                   name="payment_link"
