            ...
            <div class="mb-8">
                <div class="flex items-center justify-center space-x-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="mr-2 text-sm font-medium text-blue-600 dark:text-blue-400">پرداخت کارمزد</span>
                    </div>
                    <div class="w-8 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                    <div class="flex items-center">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    @if($paymentReceipt->status->value === 'pending_review')
                        ...
                        @else
                            <!-- Upload Form -->
                            <form method="POST" action="{{ route('buyer.auction.payment.receipt', $auction) }}"
