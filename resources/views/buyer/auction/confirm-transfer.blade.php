            ...
            <div class="mb-8">
                <div class="flex items-center justify-center space-x-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="mr-2 text-sm font-medium text-gray-900 dark:text-gray-100">انتظار انتقال</span>
                    </div>
                    <div class="w-8 h-0.5 bg-gray-300 dark:bg-gray-600"></div>
                    <div class="flex items-center">
                        ...
                        <span class="mr-2 text-sm font-medium text-blue-600 dark:text-blue-400">تأیید انتقال</span>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    ...
                    <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-6">
                        <div class="flex items-center">
                            ...
                            <span class="text-green-800 dark:text-green-200 font-medium">
                                فروشنده وام را انتقال داده است. لطفاً کد ملی خود را وارد کنید تا انتقال وام تأیید شود.
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <span class="text-sm text-blue-600 dark:text-blue-400">تاریخ انتقال:</span>
                                <p class="font-medium text-blue-600 dark:text-blue-400">{{ $loanTransfer->created_at->format('Y/m/d H:i') }}</p>
                            </div>
                            <div>
                                <span class="text-sm text-blue-600 dark:text-blue-400">کد ملی وارد شده:</span>
                            ...
                            @if($loanTransfer->transfer_receipt_path)
                                <div>
                                    ...
                                    <p class="font-medium text-blue-600 dark:text-blue-400">
                                        <a href="{{ Storage::url($loanTransfer->transfer_receipt_path) }}" target="_blank" class="underline hover:no-underline">مشاهده رسید</a>
                                    </p>
                                </div>
                            @endif
                        </div>
