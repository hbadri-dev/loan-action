...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        ...
        <p class="text-gray-600">در این صفحه می‌توانید تاریخچه تمام وام‌هایی که در آن‌ها شرکت کرده‌اید را مشاهده کنید.</p>
    </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">وضعیت پیشنهاد</th>
                        ...
                        @foreach($auctions as $auction)
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500">شناسه مزایده: {{ $auction->id }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('buyer.loan-history.show', $auction) }}"
    ...
    @else
        <div class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">شما هنوز در هیچ مزایده‌ای شرکت نکرده‌اید.</p>
        </div>
    @endif
</div>
</x-app-layout>
