<x-guest-layout>
    <div class="mb-6 text-center">
        <h2 class="text-2xl font-bold text-gray-900 mb-2">ثبت نام خریدار</h2>
        <p class="text-gray-600">برای خرید وام‌ها در مزایده ثبت نام کنید</p>
    </div>
    ...
    <div class="mt-6 text-center">
        ...
        <a href="{{ route('otp.login') }}"
           class="block w-full py-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-center">
            ورود
        </a>
    </div>
