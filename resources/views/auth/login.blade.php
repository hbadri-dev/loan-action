...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('unified.otp.login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="ایمیل خود را وارد کنید" />
